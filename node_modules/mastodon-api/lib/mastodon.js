...
var _helpers = require('mastodon-api/lib/helpers');

var _helpers2 = _interopRequireDefault(_helpers);

var _streamingApiConnection = require('mastodon-api/lib/streaming-api-connection');

var _streamingApiConnection2 = _interopRequireDefault(_streamingApiConnection);

var _settings = require('mastodon-api/lib/settings');
...
var Mastodon = function () {
    ...
    _createClass(Mastodon, [{
        ...
        value: function request(method, path, params, callback) {
            var self = this;
            (0, _assert2.default)(method === 'GET' || method === 'POST' || method === 'DELETE');
